       ...
       <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Pospectos</h4>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="row">
                                    <div class="col-lg-2 col-md-2  col-sm-2">
                                        ...
                                        <select class="form-control" id="idAgente" onchange="cargarProspectos(1);">
                                    ...
                                    <div class="col-lg-2 col-md-2  col-sm-2">
                                        ...
                                        <select class="form-control" id="comentarios" onchange="cargarProspectos(1);">

                                           <option value="">Todos</option>
                                           <option value="0">Con comentarios</option>
                                           <option value="1">Sin comentarios</option>
                                   ...
                                   <div class="col-lg-2 col-md-2  col-sm-2">
                                    ...
                                    <select class="form-control" id="per_page" onchange="cargarProspectos(1);">
                                        <option>5</option>
                                        <option>10</option>
                                ...
                                <div class="col-lg-4 col-md-4  col-sm-4">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                            <button type="button" class="btn btn-danger btn-rounded btn-icon" onclick="cargarProspectos(1);">
                                                <i class="ti-search"></i>
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-2 col-md-2">
                                    <button type="button" class="btn btn-danger  btn-icon" id="btnDescargarReporteCartera" onclick="descargarReporteProspectos();"><i class="fas fa-file-excel" aria-hidden="true"></i></button>
                                </div>
                                <div class="col-md-12 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <p class="card-title mb-0"></p>
                                            <div class="datosProspectos">
