        ...
        <div class="container-fluid">
                                ...
                                <div>
                                    ...
                                    <br>
                                     <a href="vistas/modulos/reportes.php?reporte=seguimientos" ><button type="button" class="btn btn-success">
                                        <i class="fas fa-file-excel fa-2x"></i>Seguimientos</button></a>
                                     <?php 
                                    echo "<a href='vistas/modulos/reportes.php?prospecto=prospectos&agente=".$valor."' ><button type='button' class='btn btn-secondary'>Prospectos
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 table-responsive">
                    ...
                    <table class="table table-bordered table-striped tablaProspectos tableColor" width="100%" id="prospectos">
                        ...
                        <thead class="headColor">
                           ...
                           <tr>
                             ...
                             <th style="border:none">Origen</th>
