       ...
       <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">Demostraciones </h4>
                    <div class="ml-auto text-right">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="dashboard">Inicio</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Demostraciones </li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-md-flex align-items-center">
                                <div>
                                    <a href="vistas/modulos/reportes.php?listaEventos=demostraciones" ><button type="button" class="btn btn-success">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 table-responsive">
                    ...
                    <table class="table table-bordered table-striped dt-responsive tablaDemostraciones tableColor" width="100%" id="demostraciones" >
...
<div class="modal fade" id="detalleDemostraciones" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                   ...
                   <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                            <div class="table-responsive">
                                  <table class="table" id="tablaDetalleProductosDemostracion">
...
<div class="modal fade" id="informacionDemostraciones" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header headColor" style="color: white">
