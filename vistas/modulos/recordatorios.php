        ...
        <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-md-flex align-items-center">
                                <div>
                                    <a href="vistas/modulos/reportes.php?listaEventos=recordatorios" ><button type="button" class="btn btn-success">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 table-responsive">
                    ...
                    <table class="table table-bordered table-striped dt-responsive tablaRecordatorios tableColor" width="100%" id="recordatorios" >
...
<div class="modal fade" id="informacionRecordatorios" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
